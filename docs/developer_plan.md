...
- Реализовать `workers/common/storage.py` (использует тот же storage backend)
...
- Реализовать `workers/queue/tasks.py` (декораторы для задач RQ)
- Реализовать `workers/queue/rq_worker.py` (точка входа для воркеров)
...
- Реализовать `backend/app/api/routes/health.py`:
  - `GET /health` (liveness)
...
- Реализовать `backend/app/api/routes/videos.py`:
...
- Реализовать `backend/app/api/routes/files.py` (для локального storage):
...
- Реализовать `workers/common/db.py` (подключение к БД для воркеров)
- Реализовать `workers/common/progress.py` (обновление прогресса в Redis)
- Реализовать `workers/common/schemas.py` (валидация артефактов)
- Реализовать `workers/common/contracts.py` (чтение контрактов модели)
- Реализовать `workers/common/video_io.py` (работа с видео файлами)
...
- Реализовать `workers/cpu/transcode/run.py`:
...
- Реализовать `workers/gpu/pose/triton_client.py` (клиент для Triton Inference Server)
...
- Реализовать `workers/gpu/pose/run.py`:
...
- Реализовать `workers/cpu/features/run.py`:
...
- Реализовать `workers/cpu/feedback/run.py`:

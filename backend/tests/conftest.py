...
def pytest_configure(config):
    ...
    infrastructure/test_storage.py to test the real factory.
    """
    ...
    _patches.extend(
        [
            ...
            patch(
                "backend.app.infrastructure.queue.redis_client.redis.from_url",
                return_value=mock_redis_conn,
            ),
            patch(
                "backend.app.infrastructure.db.session.create_engine",

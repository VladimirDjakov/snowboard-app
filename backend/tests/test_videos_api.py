...
from backend.app.application.use_cases.complete_upload import CompleteUploadResult
from backend.app.application.use_cases.create_video import CreateVideoResult
from backend.app.application.use_cases.get_video_artifacts import VideoArtifactResult
from backend.app.application.use_cases.get_video_status import ArtifactWithUrl, VideoStatusResult
from backend.app.composition.container import UseCases
...
def app_with_container(mock_container):
    ...
    with patch(
        "backend.app.adapters.storage.create_storage_backend",
...
class TestCreateVideo:
    ...
    def test_create_video_success(self, client, mock_use_cases):
        ...
        assert data["upload"]["object_key"] == f"raw/{video_id}/original.mp4"

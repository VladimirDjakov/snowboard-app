...
class VideoDB(Base):
    ...
    # Relationships
    stages: Mapped[list["JobStageDB"]] = relationship(
        "JobStageDB",
        back_populates="video",
        cascade="all, delete-orphan",
    )
    artifacts: Mapped[list["ArtifactDB"]] = relationship(
        "ArtifactDB",
        back_populates="video",
        cascade="all, delete-orphan",
    )
    ...
    def __repr__(self) -> str:
        return f"<VideoDB(id={self.id}, status={self.status.value})>"


class JobStageDB(Base):
    ...
    # Relationships
    video: Mapped["VideoDB"] = relationship("VideoDB", back_populates="stages")
    ...
    def __repr__(self) -> str:
        return (
            f"<JobStageDB(id={self.id}, video_id={self.video_id}, "
...
class ArtifactDB(Base):
    ...
    # Relationships
    video: Mapped["VideoDB"] = relationship("VideoDB", back_populates="artifacts")
    ...
    def __repr__(self) -> str:
        return (
            f"<ArtifactDB(id={self.id}, video_id={self.video_id}, "
